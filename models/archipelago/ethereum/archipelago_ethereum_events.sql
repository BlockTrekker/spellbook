...
trades_enhanced AS (
    ...
    LEFT JOIN tokens_ethereum_nft
        ON nft_contract_address = nft.contract_address
    LEFT JOIN nft_ethereum_aggregators
...
LEFT JOIN {{ ref('nft_ethereum_transfers') }}
    ON
