...
WITH prices AS (
   ...
   cumulative_usd_balance AS (
        ...
        LEFT JOIN dex_prices AS p2 ON p2.day <= b.day
    ...
    pool_liquidity_estimates AS (
        ...
        INNER JOIN {{ ref('balancer_v1_ethereum_pools_tokens_weights') }} AS w ON b.pool = w.pool_id
    ...
    balancer_liquidity AS (
        ...
        LEFT JOIN {{ ref('balancer_v1_ethereum_pools_tokens_weights') }} AS w ON b.pool = w.pool_id
        AND w.normalized_weight > 0
