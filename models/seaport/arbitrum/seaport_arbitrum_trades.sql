...
iv_base_pairs_priv as (
    select
        ...
        a.is_traded_nft,
        a.is_moved_nft
    from ref_seaport_arbitrum_base_pairs
    where
        1 = 1
    ...
    select
        ...
        a.is_moved_nft
    from ref_seaport_arbitrum_base_pairs
    left join ref_seaport_arbitrum_base_pairs
        on
            b.tx_hash = a.tx_hash
...
iv_nfts as (
    ...
    left join iv_volume
        on
            b.block_time = a.block_time  -- tx_hash and evt_index is PK, but for performance, block_time is included
...
iv_trades as (
    select
        ...
        sub_idx
    from iv_nfts
    inner join source_arbitrum_transactions on t.hash = a.tx_hash
